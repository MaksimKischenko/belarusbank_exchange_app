          ...
          if (state is ExchangeInfoLoading) {
            ...
            body = Column(
              ...
              children: [
                ...
                CupertinoButton(
                  onPressed: () =>
                      context.read<ExchangeBloc>().add(ExchangeInfoInit()),
            ...
            if (currencies.contains('Доллар США')) {
              itemsInfoBank.sort((a, b) => double.tryParse(b.usdIn!)!
                  .compareTo(double.tryParse(a.usdIn!)!));
              double maxUsdIn = 0;
              ...
              itemsInfoBank.removeWhere(
                  (element) => (double.tryParse(element.usdIn!)! != maxUsdIn));
            } else {
              itemsInfoBank.sort((a, b) => double.tryParse(b.eurIn!)!
                  .compareTo(double.tryParse(a.eurIn!)!));
              double maxEurIn = 0;
              for (var item in itemsInfoBank) {
              ...
              itemsInfoBank.removeWhere(
                  (element) => (double.tryParse(element.eurIn!)! != maxEurIn));
            }

            body = itemsInfoBank.isEmpty
                ? Center(
                    child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Dismissible(
                                    ...
                                    background:
                                        Container(color: AppStyles.mainColor),
                                    child: Card(
                                        ...
                                        children: [
                                          ListTile(
                                            ...
                                            title: SelectableText(
                                                'Подразделения банка: ${item.filialId} | ${item.filialsText}'),
                                            subtitle: SelectableText(
                                                'Режим работы банка: ${item.infoWorkTime}'),
                                          ),
                                        ],
                                      ),
                                    ));
