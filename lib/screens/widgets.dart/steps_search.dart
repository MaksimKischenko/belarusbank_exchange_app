...
class StepsOfSearch extends StatefulWidget {
  const StepsOfSearch({Key? key}) : super(key: key);
          ...
          Theme(
            data: ThemeData(
                colorScheme: Theme.of(context)
                    .colorScheme
                    .copyWith(primary: AppStyles.mainColor)),
            child: Stepper(
            ...
            CupertinoButton(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    context
                        .read<ExchangeBloc>()
                        .add(ExchangeInfoRun(city: selectedCity));
                  });
                  context
                      .findAncestorStateOfType<InitialInfoScreenState>()
